 ...
 * generated in the com.openkm.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetRepositoryUuidResponse_QNAME = new QName("http://ws.openkm.com", "getRepositoryUuidResponse");
    ...
    private final static QName _Mail_QNAME = new QName("http://ws.openkm.com", "mail");
    private final static QName _Document_QNAME = new QName("http://ws.openkm.com", "document");
    private final static QName _Note_QNAME = new QName("http://ws.openkm.com", "note");
    private final static QName _GetUpdateMessageResponse_QNAME = new QName("http://ws.openkm.com", "getUpdateMessageResponse");
    private final static QName _AppVersion_QNAME = new QName("http://ws.openkm.com", "appVersion");
    ...
    private final static QName _Version_QNAME = new QName("http://ws.openkm.com", "version");
    private final static QName _GetRepositoryUuid_QNAME = new QName("http://ws.openkm.com", "getRepositoryUuid");
    private final static QName _GetUpdateMessage_QNAME = new QName("http://ws.openkm.com", "getUpdateMessage");
    ...
    private final static QName _LockInfo_QNAME = new QName("http://ws.openkm.com", "lockInfo");
    private final static QName _Folder_QNAME = new QName("http://ws.openkm.com", "folder");
    private final static QName _PurgeTrash_QNAME = new QName("http://ws.openkm.com", "purgeTrash");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.openkm.ws
     * 
     */
    ...
    public JAXBElement<GetRepositoryUuidResponse> createGetRepositoryUuidResponse(GetRepositoryUuidResponse value) {
        return new JAXBElement<GetRepositoryUuidResponse>(_GetRepositoryUuidResponse_QNAME, GetRepositoryUuidResponse.class, null, value);
    }
    ...
    public JAXBElement<GetUpdateMessageResponse> createGetUpdateMessageResponse(GetUpdateMessageResponse value) {
        return new JAXBElement<GetUpdateMessageResponse>(_GetUpdateMessageResponse_QNAME, GetUpdateMessageResponse.class, null, value);
    }
    ...
    public JAXBElement<AppVersion> createAppVersion(AppVersion value) {
        return new JAXBElement<AppVersion>(_AppVersion_QNAME, AppVersion.class, null, value);
    }
    ...
    public JAXBElement<GetRepositoryUuid> createGetRepositoryUuid(GetRepositoryUuid value) {
        return new JAXBElement<GetRepositoryUuid>(_GetRepositoryUuid_QNAME, GetRepositoryUuid.class, null, value);
    }
    ...
    public JAXBElement<GetUpdateMessage> createGetUpdateMessage(GetUpdateMessage value) {
        return new JAXBElement<GetUpdateMessage>(_GetUpdateMessage_QNAME, GetUpdateMessage.class, null, value);
    }
